  ...
  const loadData = async () => {
    try {
      ...
      const mockSubscribers = [
        ...
        {
          id: 2,
          email: 'client2@example.td',
          nom: 'Marie Koné',
          phone: '+235 23 45 67 89',
          user_id: 2,
          status: 'active',
      ...
      const mockCampaigns = [
        {
          id: 1,
          title: 'Promotion Spéciale Novembre',
          subject: 'Découvrez nos nouvelles offres',
...
export default NewsletterManagement; // ✅ Export default ajouté